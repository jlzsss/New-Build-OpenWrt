...
#define PF_NON_TEMPORAL_LEVEL_ALL
  ...
  __CRT_INLINE VOID DbgRaiseAssertionFailure(void) {
    __asm__ __volatile__("int $0x2c ");  //cheat engine modification :0x2c->$0x2c
  }
...
#if(defined(_X86_) && !defined(__x86_64))
//cheat engine modification start (Remove NtCurrentTeb implementation, it's exported in ntdll.dll for 32-bit processes)
    struct _TEB *NtCurrentTeb(void);  
